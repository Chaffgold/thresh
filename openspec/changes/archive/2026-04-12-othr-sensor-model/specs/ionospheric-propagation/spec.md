## Capability: Ionospheric Propagation Model

### Overview
Model HF skywave propagation through the ionosphere for OTHR simulation. Includes Chapman-layer electron density, critical frequency, MUF/LUF, skip zones, virtual reflection height, and ionospheric sounder integration for real-time parameter estimation.
