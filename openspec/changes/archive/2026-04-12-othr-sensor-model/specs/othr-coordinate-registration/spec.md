## Capability: OTHR Coordinate Registration

### Overview
Transform OTHR ground-range/azimuth measurements to geodetic and Cartesian coordinates using great-circle geometry on the WGS84 ellipsoid.
