## Capability: OTHR Measurement Type

### Overview
Extend the thresh measurement model to support Over-the-Horizon Radar observations. OTHR measures ground range (along Earth's surface via ionospheric skip), azimuth, and Doppler velocity — fundamentally different from conventional slant-range radar.
