## Capability: OTHR Tracker Integration

### Overview
Integrate OTHR measurements into the multi-object tracker with appropriate observation models, gating, and fusion with conventional sensors.
