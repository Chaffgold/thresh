## Capability: Joint Probabilistic Data Association

### Overview

JPDA computes association probabilities for all track-detection pairs within the gating region and updates each track with a probability-weighted combination of all feasible detections, preserving uncertainty about the correct association rather than making hard assignments.
