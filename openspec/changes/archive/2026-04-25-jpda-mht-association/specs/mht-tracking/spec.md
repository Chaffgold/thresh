## Capability: Multi-Hypothesis Tracking

### Overview

MHT maintains a tree of association hypotheses over a sliding window, deferring hard association decisions and pruning unlikely branches via N-scan and k-best strategies. This allows the tracker to resolve ambiguous associations retroactively as more data arrives.
