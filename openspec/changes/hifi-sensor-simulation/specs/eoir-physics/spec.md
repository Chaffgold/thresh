## Capability: EO/IR Sensor Physics Modeling

### Overview
Implements electro-optical and infrared (EO/IR) sensor physics modeling for realistic passive sensor simulation. This includes target infrared signature computation from thermal emission (engine exhaust, skin heating, plume), atmospheric transmission modeling through molecular absorption and aerosol scattering, sensor noise modeling via noise equivalent temperature difference (NETD), and detection range estimation based on target-to-background contrast and sensor signal-to-noise ratio. Supports both MWIR (3-5 micrometer) and LWIR (8-12 micrometer) spectral bands.
...
| Band | Wavelength | Best For | Atmospheric Window |
|------|-----------|----------|-------------------|
| MWIR | 3-5 micrometer | Hot targets (>800 K), engine exhaust | Good, except CO2 at 4.3 micrometer |
| LWIR | 8-12 micrometer | Warm targets (300-500 K), skin emission | Good, except O3 at 9.6 micrometer |

### Key References
- Hudson, R.D. "Infrared System Engineering," Wiley, 1969
- Accetta, J.S. and Shumaker, D.L. "The Infrared and Electro-Optical Systems Handbook," SPIE, 1993
