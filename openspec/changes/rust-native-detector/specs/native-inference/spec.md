## Capability: Rust-Native Detection Inference

### Overview

The Rust-native detection head implements a simplified DETR decoder (6 layers, 256-dim, 8 heads) entirely in Rust using nalgebra, enabling inference without ONNX Runtime. Weights are loaded from SafeTensors format. The detector produces class logits and bounding box coordinates from input queries.
